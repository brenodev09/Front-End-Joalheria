...
// Recebe os status/labels e a lista de tipos de cupom disponíveis vindos da
// página, que é quem tem a lista completa de cupons carregada.
    ...
    >
      <div className={styles.campoBusca}>
        ...
        <input
          ...
          placeholder="Buscar por nome ou tipo do cupom"
